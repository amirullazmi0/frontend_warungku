        ...
        <div className='flex justify-center items-center min-h-screen p-4'>
            <div className="card shadow-lg grid lg:md:grid-cols-2 overflow-hidden min-w-[50vw] bg-white">
                <div className="card-body">
                    ...
                    {loginError &&
                        <div className="mb-4">
                            <Alert severity="error" className='capitalize'>{loginError}</Alert>
                        </div>
                    }
                    {loginSuccess &&
                    ...
                    <form action="">
                        <div className="flex flex-col gap-4">
                            ...
                            <Button onClick={handleSubmit(onSubmit)} className='w-[50%]' type='submit' variant="contained">Login</Button>
                        </div>
                    </form>
