                                ...
                                <div className="flex flex-col gap-4 mt-5">
                                    <div className="grid lg:md:grid-cols-10 items-start">
                                        ...
                                        <div className="lg:md:col-span-7">
                                            {profile ?
                                                <TextField name="email" onChange={handleChange} id="outlined-basic" className='w-full' value={profile?.email} variant="outlined" />
                                                :
                                    ...
                                    <div className="grid lg:md:grid-cols-10 items-start">
                                        ...
                                        <div className="lg:md:col-span-7">
                                            {profile ?
                                                <TextField name="fullName" onChange={handleChange} id="outlined-basic" className='w-full' value={profile?.fullName} variant="outlined" />
                                                :
                                                <Skeleton variant="text" sx={{ fontSize: '1rem' }} />
                                            }
                                        </div>
